...
<div class="modal fade" id="edit-modal-product" role="dialog" aria-labelledby="modelTitleId"
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title">Ubah Data product</h4>

            </div>
            <div class="modal-body">
                <form id="edit-form-product" method="POST">
                    @csrf
                    @method('put')
                    <div class="form-group">
                            <label for="">Nama Product</label>
                            <input type="text" name="pd_nama" id="modal-input-nama" class="form-control" placeholder="" required>
                        </div>
                        <div class="form-group">
                            <label for="">Kategori</label>
                            <select class="form-control select2" name="pd_kategori" id="modal-input-kategori" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="pd_brand" id="modal-input-brand" required>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="pd_tipe" id="modal-input-tipe">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="pd_design" id="modal-input-design">
                                <option value="" disabled>-VALVES-</option>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="pd_material" id="modal-input-material">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="pd_harga" id="modal-input-harga" class="form-control" required>
                        </div>
